...
public interface FFIoItemDataRepository
    ...
    /**
     * Retrieves a list of io item datas by their classRestrictions.
     * @param classRestrictions the classRestrictions
     * @return {@link List}<{@link FFIoItemDataEntity}>
     */
    List<FFIoItemDataEntity> findByClassRestrictions(Long classRestrictions);
    /**
     ...
     * @return {@link List}<{@link FFIoItemDataEntity}>
     */
    List<FFIoItemDataEntity> findByItemName(String itemName);
    /**
     ...
     * @return {@link List}<{@link FFIoItemDataEntity}>
     */
    List<FFIoItemDataEntity> findByPrice(Long price);
    /**
     * Retrieves a list of io item datas by their raceRestrictions.
     * @param raceRestrictions the raceRestrictions
     * @return {@link List}<{@link FFIoItemDataEntity}>
     */
    List<FFIoItemDataEntity> findByRaceRestrictions(Long raceRestrictions);
    /**
     ...
     * @return {@link List}<{@link FFIoItemDataEntity}>
     */
    List<FFIoItemDataEntity> findByWeight(Long weight);
}
