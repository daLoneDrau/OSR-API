...
public final class LABLORDEquipmentEntity {
	...
	@ElementCollection
	@CollectionTable(name = "equipment_cost_lookup", schema = "lablord", joinColumns = @JoinColumn(name = "equipment_id") )
	...
	@SequenceGenerator(name = "equipment_seq", sequenceName = "lablord.equipment_id_seq", allocationSize = 1)
	private Long								id;
	 ...
	 */
	@OneToMany(targetEntity = LABLORDEquipmentTypeEntity.class, fetch = FetchType.EAGER)
	@Fetch(FetchMode.SELECT)
	@JoinTable(name = "equipment_type_lookup", schema = "lablord", joinColumns = @JoinColumn(name = "equipment_id", referencedColumnName = "equipment_id") , inverseJoinColumns = @JoinColumn(name = "equipment_type_id", referencedColumnName = "equipment_type_id") )
	@JsonProperty("type")
