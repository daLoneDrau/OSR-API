...
public final class WFRPCareerTypeEntity {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "career_type_seq")
	@SequenceGenerator(name = "career_type_seq", sequenceName = "wfrp.career_type_id_seq", allocationSize = 1)
	private Long	id;
	/** the name. */
	@Column(name = "name")
	@JsonProperty("name")
