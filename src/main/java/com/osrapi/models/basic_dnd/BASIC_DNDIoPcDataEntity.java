...
public final class BASIC_DNDIoPcDataEntity {
    ...
    /**
     * the list of keyring associated with this {@link BASIC_DNDIoPcDataEntity}.
     */
    @Column
    ...
    private long level;
    /**
     * the list of name associated with this {@link BASIC_DNDIoPcDataEntity}.
     */
    @Column
    @ElementCollection(targetClass = String.class)
     ...
     * @param val the new value
     */
    public void setGender(final long val) {
        gender = val;
    }
    /**
     * Sets the gold.
