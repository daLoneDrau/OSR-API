...
public class FFScriptActionController {
    ...
    public List<Resource<FFScriptActionEntity>> getByAttribute(
        ...
        Iterator<FFScriptActionEntity> iter =
                repository.findByAttribute(attribute)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> getByDestination(
        ...
        Iterator<FFScriptActionEntity> iter =
                repository.findByDestination(destination)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> getByDirection(
        ...
        Iterator<FFScriptActionEntity> iter =
                repository.findByDirection(direction)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> getByDoorName(
        ...
        Iterator<FFScriptActionEntity> iter =
                repository.findByDoorName(doorName)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> getByFailScripts(
            @PathVariable
            final String failScripts) {
        Iterator<FFScriptActionEntity> iter =
                repository.findByFailScripts(failScripts)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> getByIsDieRoll(
            @PathVariable
            final Boolean isDieRoll) {
        Iterator<FFScriptActionEntity> iter =
                repository.findByIsDieRoll(isDieRoll)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> getByNumDieRolled(
            @PathVariable
            final Long numDieRolled) {
        Iterator<FFScriptActionEntity> iter =
                repository.findByNumDieRolled(numDieRolled)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> getByPassScripts(
            @PathVariable
            final String passScripts) {
        Iterator<FFScriptActionEntity> iter =
                repository.findByPassScripts(passScripts)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> getByRoomCode(
        ...
        Iterator<FFScriptActionEntity> iter =
                repository.findByRoomCode(roomCode)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> getByTextName(
        ...
        Iterator<FFScriptActionEntity> iter =
                repository.findByTextName(textName)
                        .iterator();
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<FFScriptActionEntity>> save(
            @RequestBody
            final List<FFScriptActionEntity> entities) {
        List<Resource<FFScriptActionEntity>> resources =
                new ArrayList<Resource<FFScriptActionEntity>>();
