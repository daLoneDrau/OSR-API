...
public class FFEquipmentItemModifierController {
    ...
    public List<Resource<FFEquipmentItemModifierEntity>> getByCode(
            @PathVariable
            final String code) {
        Iterator<FFEquipmentItemModifierEntity> iter =
    ...
    /**
     * Gets a list of {@link FFEquipmentItemModifierEntity}s that share a
     * percent.
     ...
     */
    private Resource<FFEquipmentItemModifierEntity>
     ...
     * @param entities the list of {@link FFEquipmentItemModifierEntity}
     *            instances
     * @return {@link List}<{@link Resource}<{@link FFEquipmentItemModifierEntity}>>
     */
    ...
    public List<Resource<FFEquipmentItemModifierEntity>> save(
            @RequestBody
            final List<FFEquipmentItemModifierEntity> entities) {
        List<Resource<FFEquipmentItemModifierEntity>> resources =
                new ArrayList<Resource<FFEquipmentItemModifierEntity>>();
     ...
     */
    private void
            setIdFromRepository(final FFEquipmentItemModifierEntity entity) {
        ...
        try {
            ...
            try {
                ...
                field = FFEquipmentItemModifierEntity.class
            ...
            if (old == null
                ...
                if (method != null
                    ...
                    field.setAccessible(true);
                    if (field.get(entity) != null) {
                        old = (List<FFEquipmentItemModifierEntity>) method
                                .invoke(
                                        repository, (String) field.get(entity));
                    }
                }
