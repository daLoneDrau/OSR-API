...
public class CRYPTS_THINGSLifeEventController {
    ...
    /**
     * Gets a list of {@link CRYPTS_THINGSLifeEventEntity}s that share a
     * description.
    ...
    public List<Resource<CRYPTS_THINGSLifeEventEntity>> getByDescription(
        ...
        Iterator<CRYPTS_THINGSLifeEventEntity> iter =
        ...
        if (entity.getModifiers() != null
            ...
            for (int i = entity.getModifiers().size() - 1; i >= 0; i--) {
                ...
                try {
                    Method method = null;
                    try {
                        method = CRYPTS_THINGSEquipmentItemModifierController.class
                                .getDeclaredMethod(
                                        "getByName",
                    ...
                    if (list == null) {
                        ...
                        if (method != null
                            ...
                            field.setAccessible(true);
                            if (field.get(
                                    entity.getModifiers().get(i)) != null) {
                                list = (List<Resource<
                                        CRYPTS_THINGSEquipmentItemModifierEntity>>) method
                                                .invoke(
                                                        CRYPTS_THINGSEquipmentItemModifierController
                ...
                if (modifiers == null) {
                    modifiers =
                            (CRYPTS_THINGSEquipmentItemModifierEntity) ((Resource) CRYPTS_THINGSEquipmentItemModifierController
                                    .getInstance()
                                    .save(entity.getModifiers().get(i)).get(0))
                                            .getContent();
                }
     ...
     * @param entities the list of {@link CRYPTS_THINGSLifeEventEntity}
     *            instances
     * @return {@link List}<{@link Resource}<{@link CRYPTS_THINGSLifeEventEntity}>>
     */
    ...
    public List<Resource<CRYPTS_THINGSLifeEventEntity>> save(
            @RequestBody
            final List<CRYPTS_THINGSLifeEventEntity> entities) {
        List<Resource<CRYPTS_THINGSLifeEventEntity>> resources =
                new ArrayList<Resource<CRYPTS_THINGSLifeEventEntity>>();
     ...
     */
    private void
            setIdFromRepository(final CRYPTS_THINGSLifeEventEntity entity) {
        ...
        try {
            ...
            if (old == null
                ...
                if (method != null
                    ...
                    field.setAccessible(true);
                    if (field.get(entity) != null) {
                        old = (List<CRYPTS_THINGSLifeEventEntity>) method
                                .invoke(
                                        repository, (String) field.get(entity));
                    }
                }
