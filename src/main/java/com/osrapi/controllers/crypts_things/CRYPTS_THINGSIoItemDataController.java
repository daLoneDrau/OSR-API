...
public class CRYPTS_THINGSIoItemDataController {
    ...
    public List<Resource<CRYPTS_THINGSIoItemDataEntity>> getByCount(
            @PathVariable
            final Long count) {
        Iterator<CRYPTS_THINGSIoItemDataEntity> iter =
                repository.findByCount(count)
                        .iterator();
        List<Resource<CRYPTS_THINGSIoItemDataEntity>> resources =
                new ArrayList<Resource<CRYPTS_THINGSIoItemDataEntity>>();
        while (iter.hasNext()) {
    ...
    /**
     * Gets a list of {@link CRYPTS_THINGSIoItemDataEntity}s that share a
     * description.
    ...
    public List<Resource<CRYPTS_THINGSIoItemDataEntity>> save(
        ...
        if (entity.getGroups() != null
            ...
            for (int i = entity.getGroups().size() - 1; i >= 0; i--) {
                ...
                try {
                    Method method = null;
                    try {
                        method = CRYPTS_THINGSGroupController.class
                                .getDeclaredMethod(
                                        "getByName",
                    ...
                    if (method != null
                        ...
                        if (field.get(entity.getGroups().get(i)) != null) {
                            list = (List<
                                    Resource<CRYPTS_THINGSGroupEntity>>) method
                                            .invoke(
                    ...
                    if (list == null) {
                        ...
                        if (method != null
                            ...
                            if (field.get(entity.getGroups().get(i)) != null) {
                                list = (List<Resource<
                                        CRYPTS_THINGSGroupEntity>>) method
                                                .invoke(
                                                        CRYPTS_THINGSGroupController
                                                                .getInstance(),
                                                        (String) field
        ...
        if (entity.getTypes() != null
            ...
            for (int i = entity.getTypes().size() - 1; i >= 0; i--) {
                ...
                try {
                    Method method = null;
                    try {
                        method = CRYPTS_THINGSObjectTypeController.class
                                .getDeclaredMethod(
                                        "getByName",
                                        new Class[] { String.class });
                    } catch (NoSuchMethodException e) {
                    ...
                    if (method != null
                        ...
                        if (field.get(entity.getTypes().get(i)) != null) {
                            list = (List<Resource<
                                    CRYPTS_THINGSObjectTypeEntity>>) method
                                            .invoke(
        ...
        if (entity.getDamage() != null
                && entity.getDamage().getId() == null) {
            setDamageIdFromRepository(entity);
        }
     ...
     * @param entities the list of {@link CRYPTS_THINGSIoItemDataEntity}
     *            instances
     * @return {@link List}<{@link Resource}<{@link CRYPTS_THINGSIoItemDataEntity}>>
     */
    ...
    public List<Resource<CRYPTS_THINGSIoItemDataEntity>> save(
            @RequestBody
            final List<CRYPTS_THINGSIoItemDataEntity> entities) {
        List<Resource<CRYPTS_THINGSIoItemDataEntity>> resources =
                new ArrayList<Resource<CRYPTS_THINGSIoItemDataEntity>>();
    ...
    private void setDamageIdFromRepository(
            final CRYPTS_THINGSIoItemDataEntity entity) {
        ...
        try {
            ...
            if (method != null
                    && field != null) {
                field.setAccessible(true);
                if (field.get(entity.getDamage()) != null) {
                    list = (List<Resource<CRYPTS_THINGSDiceEntity>>) method
                            .invoke(
                                    CRYPTS_THINGSDiceController.getInstance(),
                                    (String) field
                                            .get(entity.getDamage()));
                }
            }
            if (list == null) {
                try {
                    method = CRYPTS_THINGSDiceController.class
                            .getDeclaredMethod(
                ...
                if (method != null
                    ...
                    if (field.get(entity.getDamage()) != null) {
                        list = (List<Resource<CRYPTS_THINGSDiceEntity>>) method
                                .invoke(CRYPTS_THINGSDiceController
        ...
        if (memberEntity == null) {
            memberEntity =
                    (CRYPTS_THINGSDiceEntity) ((Resource) CRYPTS_THINGSDiceController
                            .getInstance().save(
                                    entity.getDamage())
                            .get(0)).getContent();
        }
        entity.setDamage(memberEntity);
        list = null;
    }
    /**
     ...
     */
    private void
            setIdFromRepository(final CRYPTS_THINGSIoItemDataEntity entity) {
        ...
        try {
            ...
            try {
                ...
                field = CRYPTS_THINGSIoItemDataEntity.class
                        .getDeclaredField("name");
            } catch (NoSuchMethodException | NoSuchFieldException e) {
            ...
            if (old == null
                ...
                if (method != null
                    ...
                    field.setAccessible(true);
                    if (field.get(entity) != null) {
                        old = (List<CRYPTS_THINGSIoItemDataEntity>) method
                                .invoke(
                                        repository, (String) field.get(entity));
                    }
                }
