...
public class CRYPTS_THINGSIoPcDataController {
    ...
    public List<Resource<CRYPTS_THINGSIoPcDataEntity>> getByFlags(
            @PathVariable
            final Long flags) {
        Iterator<CRYPTS_THINGSIoPcDataEntity> iter =
                repository.findByFlags(flags)
                        .iterator();
        List<Resource<CRYPTS_THINGSIoPcDataEntity>> resources =
                new ArrayList<Resource<CRYPTS_THINGSIoPcDataEntity>>();
        while (iter.hasNext()) {
    ...
    /**
     * Gets a list of {@link CRYPTS_THINGSIoPcDataEntity}s that share a
     * interfaceFlags.
        ...
        if (entity.getLifeEvents() != null
            ...
            for (int i = entity.getLifeEvents().size() - 1; i >= 0; i--) {
                ...
                try {
                    Method method = null;
                    try {
                        method = CRYPTS_THINGSLifeEventController.class
                                .getDeclaredMethod(
                                        "getByName",
                                        new Class[] { String.class });
                    } catch (NoSuchMethodException e) {
                    ...
                    if (method != null
                        ...
                        if (field.get(entity.getLifeEvents().get(i)) != null) {
                            list = (List<Resource<
                                    CRYPTS_THINGSLifeEventEntity>>) method
                                            .invoke(
                                                    CRYPTS_THINGSLifeEventController
                                                            .getInstance(),
                                                    (String) field.get(
                                                            entity.getLifeEvents()
                                                                    .get(i)));
                        }
                    }
                    if (list == null) {
                        ...
                        if (method != null
                            ...
                            field.setAccessible(true);
                            if (field.get(
                                    entity.getLifeEvents().get(i)) != null) {
                                list = (List<Resource<
                                        CRYPTS_THINGSLifeEventEntity>>) method
                                                .invoke(
                                                        CRYPTS_THINGSLifeEventController
                ...
                if (lifeEvents == null) {
                    lifeEvents =
                            (CRYPTS_THINGSLifeEventEntity) ((Resource) CRYPTS_THINGSLifeEventController
                                    .getInstance()
                                    .save(entity.getLifeEvents().get(i)).get(0))
                                            .getContent();
                }
    ...
    public List<Resource<CRYPTS_THINGSIoPcDataEntity>> save(
            @RequestBody
            final List<CRYPTS_THINGSIoPcDataEntity> entities) {
        List<Resource<CRYPTS_THINGSIoPcDataEntity>> resources =
                new ArrayList<Resource<CRYPTS_THINGSIoPcDataEntity>>();
    ...
    private void setGenderIdFromRepository(
        ...
        try {
            ...
            if (list == null) {
                try {
                    method = CRYPTS_THINGSGenderController.class
                            .getDeclaredMethod(
                ...
                if (method != null
                    ...
                    if (field.get(entity.getGender()) != null) {
                        list = (List<
                                Resource<CRYPTS_THINGSGenderEntity>>) method
                                        .invoke(CRYPTS_THINGSGenderController
                                                .getInstance(),
                                                (String) field.get(
                                                        entity.getGender()));
                    }
        ...
        if (memberEntity == null) {
            memberEntity =
                    (CRYPTS_THINGSGenderEntity) ((Resource) CRYPTS_THINGSGenderController
                            .getInstance().save(
                                    entity.getGender())
                            .get(0)).getContent();
        }
    ...
    private void setIdFromRepository(final CRYPTS_THINGSIoPcDataEntity entity) {
        ...
        try {
            ...
            try {
                ...
                field = CRYPTS_THINGSIoPcDataEntity.class
                        .getDeclaredField("name");
            } catch (NoSuchMethodException | NoSuchFieldException e) {
