...
public class CRYPTS_THINGSObjectTypeController {
    ...
    public List<Resource<CRYPTS_THINGSObjectTypeEntity>> getByCode(
            @PathVariable
            final String code) {
        Iterator<CRYPTS_THINGSObjectTypeEntity> iter =
     ...
     * @param entities the list of {@link CRYPTS_THINGSObjectTypeEntity}
     *            instances
     * @return {@link List}<{@link Resource}<{@link CRYPTS_THINGSObjectTypeEntity}>>
     */
    ...
    public List<Resource<CRYPTS_THINGSObjectTypeEntity>> save(
            @RequestBody
            final List<CRYPTS_THINGSObjectTypeEntity> entities) {
        List<Resource<CRYPTS_THINGSObjectTypeEntity>> resources =
                new ArrayList<Resource<CRYPTS_THINGSObjectTypeEntity>>();
     ...
     */
    private void
            setIdFromRepository(final CRYPTS_THINGSObjectTypeEntity entity) {
        ...
        try {
            ...
            if (old == null
                ...
                if (method != null
                    ...
                    field.setAccessible(true);
                    if (field.get(entity) != null) {
                        old = (List<CRYPTS_THINGSObjectTypeEntity>) method
                                .invoke(
                                        repository, (String) field.get(entity));
                    }
                }
