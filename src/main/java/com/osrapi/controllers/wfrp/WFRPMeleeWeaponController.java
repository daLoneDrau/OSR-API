...
public class WFRPMeleeWeaponController {
    ...
    public List<Resource<WFRPMeleeWeaponEntity>> getAll() {
        Iterator<WFRPMeleeWeaponEntity> iter = repository.findAll()
                .iterator();
        List<Resource<WFRPMeleeWeaponEntity>> resources =
                new ArrayList<Resource<WFRPMeleeWeaponEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<WFRPMeleeWeaponEntity> getMeleeWeaponResource(
        ...
        Resource<WFRPMeleeWeaponEntity> resource =
                new Resource<WFRPMeleeWeaponEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<WFRPMeleeWeaponEntity>> save(
            @RequestBody
            final List<WFRPMeleeWeaponEntity> entities) {
        List<Resource<WFRPMeleeWeaponEntity>> resources =
                new ArrayList<Resource<WFRPMeleeWeaponEntity>>();
