...
public class WFRPArmourCoverageController {
    ...
    public List<Resource<WFRPArmourCoverageEntity>> getAll() {
        Iterator<WFRPArmourCoverageEntity> iter = repository.findAll()
                .iterator();
        List<Resource<WFRPArmourCoverageEntity>> resources =
                new ArrayList<Resource<WFRPArmourCoverageEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<WFRPArmourCoverageEntity> getArmourCoverageResource(
        ...
        Resource<WFRPArmourCoverageEntity> resource =
                new Resource<WFRPArmourCoverageEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<WFRPArmourCoverageEntity>> save(
            @RequestBody
            final List<WFRPArmourCoverageEntity> entities) {
        List<Resource<WFRPArmourCoverageEntity>> resources =
                new ArrayList<Resource<WFRPArmourCoverageEntity>>();
