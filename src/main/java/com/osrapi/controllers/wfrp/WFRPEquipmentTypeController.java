...
public class WFRPEquipmentTypeController {
    ...
    public List<Resource<WFRPEquipmentTypeEntity>> getAll() {
        Iterator<WFRPEquipmentTypeEntity> iter = repository.findAll()
                .iterator();
        List<Resource<WFRPEquipmentTypeEntity>> resources =
                new ArrayList<Resource<WFRPEquipmentTypeEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<WFRPEquipmentTypeEntity> getEquipmentTypeResource(
        ...
        Resource<WFRPEquipmentTypeEntity> resource =
                new Resource<WFRPEquipmentTypeEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<WFRPEquipmentTypeEntity>> save(
            @RequestBody
            final List<WFRPEquipmentTypeEntity> entities) {
        List<Resource<WFRPEquipmentTypeEntity>> resources =
                new ArrayList<Resource<WFRPEquipmentTypeEntity>>();
