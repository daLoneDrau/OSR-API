...
public class WFRPSkillChoiceController {
    ...
    public List<Resource<WFRPSkillChoiceEntity>> getAll() {
        Iterator<WFRPSkillChoiceEntity> iter = repository.findAll()
                .iterator();
        List<Resource<WFRPSkillChoiceEntity>> resources =
                new ArrayList<Resource<WFRPSkillChoiceEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<WFRPSkillChoiceEntity> getSkillChoiceResource(
        ...
        Resource<WFRPSkillChoiceEntity> resource =
                new Resource<WFRPSkillChoiceEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<WFRPSkillChoiceEntity>> save(
            @RequestBody
            final List<WFRPSkillChoiceEntity> entities) {
        List<Resource<WFRPSkillChoiceEntity>> resources =
                new ArrayList<Resource<WFRPSkillChoiceEntity>>();
