...
public class WFRPSkillTypeController {
	...
	public List<Resource<WFRPSkillTypeEntity>> getAll() {
		Iterator<WFRPSkillTypeEntity> iter = repository.findAll()
				.iterator();
		List<Resource<WFRPSkillTypeEntity>> resources = new ArrayList<Resource<WFRPSkillTypeEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<WFRPSkillTypeEntity> getSkillTypeResource(
		...
		Resource<WFRPSkillTypeEntity> resource = new Resource<WFRPSkillTypeEntity>(
				entity);
		// link to entity
	...
	public List<Resource<WFRPSkillTypeEntity>> save(
			@RequestBody final List<WFRPSkillTypeEntity> entities) {
		List<Resource<WFRPSkillTypeEntity>> resources = new ArrayList<Resource<WFRPSkillTypeEntity>>();
	...
	public List<Resource<WFRPSkillTypeEntity>> save(
			@RequestBody final WFRPSkillTypeEntity entity) {
