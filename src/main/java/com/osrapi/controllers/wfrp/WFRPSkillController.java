...
public class WFRPSkillController {
	...
	public List<Resource<WFRPSkillEntity>> getAll() {
		Iterator<WFRPSkillEntity> iter = repository.findAll()
				.iterator();
		List<Resource<WFRPSkillEntity>> resources = new ArrayList<Resource<WFRPSkillEntity>>();
		while (iter.hasNext()) {
	...
	public List<Resource<WFRPSkillEntity>> save(
			@RequestBody final List<WFRPSkillEntity> entities) {
		List<Resource<WFRPSkillEntity>> resources = new ArrayList<Resource<WFRPSkillEntity>>();
	...
	public List<Resource<WFRPSkillEntity>> save(
			@RequestBody final WFRPSkillEntity entity) {
		if (entity.getCharacteristic() != null
			...
			if (characteristic == null) {
				characteristic = (WFRPCharacteristicEntity) ((Resource) WFRPCharacteristicController
						.getInstance()
						.save(entity.getCharacteristic()).get(0)).getContent();
			}
