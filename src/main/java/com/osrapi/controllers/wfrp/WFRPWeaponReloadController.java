...
public class WFRPWeaponReloadController {
	...
	public List<Resource<WFRPWeaponReloadEntity>> getAll() {
		Iterator<WFRPWeaponReloadEntity> iter = repository.findAll()
				.iterator();
		List<Resource<WFRPWeaponReloadEntity>> resources = new ArrayList<Resource<WFRPWeaponReloadEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<WFRPWeaponReloadEntity> getWeaponReloadResource(
		...
		Resource<WFRPWeaponReloadEntity> resource = new Resource<WFRPWeaponReloadEntity>(
				entity);
		// link to entity
	...
	public List<Resource<WFRPWeaponReloadEntity>> save(
			@RequestBody final List<WFRPWeaponReloadEntity> entities) {
		List<Resource<WFRPWeaponReloadEntity>> resources = new ArrayList<Resource<WFRPWeaponReloadEntity>>();
	...
	public List<Resource<WFRPWeaponReloadEntity>> save(
			@RequestBody final WFRPWeaponReloadEntity entity) {
