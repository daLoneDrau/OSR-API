...
public class WFRPSourcebookController {
	...
	public List<Resource<WFRPSourcebookEntity>> getAll() {
		Iterator<WFRPSourcebookEntity> iter = repository.findAll()
				.iterator();
		List<Resource<WFRPSourcebookEntity>> resources = new ArrayList<Resource<WFRPSourcebookEntity>>();
		while (iter.hasNext()) {
	...
	public List<Resource<WFRPSourcebookEntity>> getByOwned(
			@PathVariable final Boolean owned) {
	...
	private Resource<WFRPSourcebookEntity> getSourcebookResource(
		...
		Resource<WFRPSourcebookEntity> resource = new Resource<WFRPSourcebookEntity>(
				entity);
		// link to entity
	...
	public List<Resource<WFRPSourcebookEntity>> save(
			@RequestBody final List<WFRPSourcebookEntity> entities) {
		List<Resource<WFRPSourcebookEntity>> resources = new ArrayList<Resource<WFRPSourcebookEntity>>();
	...
	public List<Resource<WFRPSourcebookEntity>> save(
			@RequestBody final WFRPSourcebookEntity entity) {
