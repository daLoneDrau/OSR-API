...
public class WFRPGenderController {
	...
	public List<Resource<WFRPGenderEntity>> getAll() {
		Iterator<WFRPGenderEntity> iter = repository.findAll()
				.iterator();
		List<Resource<WFRPGenderEntity>> resources = new ArrayList<Resource<WFRPGenderEntity>>();
		while (iter.hasNext()) {
	...
	public List<Resource<WFRPGenderEntity>> save(
			@RequestBody final List<WFRPGenderEntity> entities) {
		List<Resource<WFRPGenderEntity>> resources = new ArrayList<Resource<WFRPGenderEntity>>();
	...
	public List<Resource<WFRPGenderEntity>> save(
			@RequestBody final WFRPGenderEntity entity) {
