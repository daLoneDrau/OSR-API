...
public class WFRPCareerTypeController {
	...
	public List<Resource<WFRPCareerTypeEntity>> getAll() {
		Iterator<WFRPCareerTypeEntity> iter = repository.findAll()
				.iterator();
		List<Resource<WFRPCareerTypeEntity>> resources = new ArrayList<Resource<WFRPCareerTypeEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<WFRPCareerTypeEntity> getCareerTypeResource(
		...
		Resource<WFRPCareerTypeEntity> resource = new Resource<WFRPCareerTypeEntity>(
				entity);
		// link to entity
	...
	public List<Resource<WFRPCareerTypeEntity>> save(
			@RequestBody final List<WFRPCareerTypeEntity> entities) {
		List<Resource<WFRPCareerTypeEntity>> resources = new ArrayList<Resource<WFRPCareerTypeEntity>>();
	...
	public List<Resource<WFRPCareerTypeEntity>> save(
			@RequestBody final WFRPCareerTypeEntity entity) {
