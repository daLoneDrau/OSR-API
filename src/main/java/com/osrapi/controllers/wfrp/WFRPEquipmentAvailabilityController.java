...
public class WFRPEquipmentAvailabilityController {
	...
	public List<Resource<WFRPEquipmentAvailabilityEntity>> getAll() {
		Iterator<WFRPEquipmentAvailabilityEntity> iter = repository.findAll()
				.iterator();
		List<Resource<WFRPEquipmentAvailabilityEntity>> resources = new ArrayList<Resource<WFRPEquipmentAvailabilityEntity>>();
		while (iter.hasNext()) {
	 ...
	 */
	private Resource<WFRPEquipmentAvailabilityEntity> getEquipmentAvailabilityResource(
			final WFRPEquipmentAvailabilityEntity entity) {
		Resource<WFRPEquipmentAvailabilityEntity> resource = new Resource<WFRPEquipmentAvailabilityEntity>(
				entity);
		// link to entity
	...
	public List<Resource<WFRPEquipmentAvailabilityEntity>> save(
			@RequestBody final List<WFRPEquipmentAvailabilityEntity> entities) {
		List<Resource<WFRPEquipmentAvailabilityEntity>> resources = new ArrayList<Resource<WFRPEquipmentAvailabilityEntity>>();
	...
	public List<Resource<WFRPEquipmentAvailabilityEntity>> save(
			@RequestBody final WFRPEquipmentAvailabilityEntity entity) {
