...
public class WFRPCharacteristicController {
    ...
    public List<Resource<WFRPCharacteristicEntity>> getAll() {
        Iterator<WFRPCharacteristicEntity> iter = repository.findAll()
                .iterator();
        List<Resource<WFRPCharacteristicEntity>> resources =
                new ArrayList<Resource<WFRPCharacteristicEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<WFRPCharacteristicEntity> getCharacteristicResource(
        ...
        Resource<WFRPCharacteristicEntity> resource =
                new Resource<WFRPCharacteristicEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<WFRPCharacteristicEntity>> save(
            @RequestBody
            final List<WFRPCharacteristicEntity> entities) {
        List<Resource<WFRPCharacteristicEntity>> resources =
                new ArrayList<Resource<WFRPCharacteristicEntity>>();
