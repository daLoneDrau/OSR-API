...
public class WFRPArmourTypeController {
    ...
    public List<Resource<WFRPArmourTypeEntity>> getAll() {
        Iterator<WFRPArmourTypeEntity> iter = repository.findAll()
                .iterator();
        List<Resource<WFRPArmourTypeEntity>> resources =
                new ArrayList<Resource<WFRPArmourTypeEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<WFRPArmourTypeEntity> getArmourTypeResource(
        ...
        Resource<WFRPArmourTypeEntity> resource =
                new Resource<WFRPArmourTypeEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<WFRPArmourTypeEntity>> save(
            @RequestBody
            final List<WFRPArmourTypeEntity> entities) {
        List<Resource<WFRPArmourTypeEntity>> resources =
                new ArrayList<Resource<WFRPArmourTypeEntity>>();
