...
public class WFRPCareerController {
    ...
    public List<Resource<WFRPCareerEntity>> getAll() {
        Iterator<WFRPCareerEntity> iter = repository.findAll()
                .iterator();
        List<Resource<WFRPCareerEntity>> resources =
                new ArrayList<Resource<WFRPCareerEntity>>();
        while (iter.hasNext()) {
     ...
     * @return {@link List}<{@link Resource}<{@link WFRPCareerEntity}>>
     */
    @RequestMapping(path = "advance_fel/{advanceFel}",
            method = RequestMethod.GET)
    public List<Resource<WFRPCareerEntity>> getByAdvanceFel(
            @PathVariable
            final Long advanceFel) {
     ...
     * @return {@link List}<{@link Resource}<{@link WFRPCareerEntity}>>
     */
    @RequestMapping(path = "advance_int/{advanceInt}",
            method = RequestMethod.GET)
    public List<Resource<WFRPCareerEntity>> getByAdvanceInt(
            @PathVariable
            final Long advanceInt) {
        Iterator<WFRPCareerEntity> iter = repository
     ...
     * @return {@link List}<{@link Resource}<{@link WFRPCareerEntity}>>
     */
    @RequestMapping(path = "advance_mag/{advanceMag}",
            method = RequestMethod.GET)
    public List<Resource<WFRPCareerEntity>> getByAdvanceMag(
            @PathVariable
            final Long advanceMag) {
        Iterator<WFRPCareerEntity> iter = repository
     ...
     * @return {@link List}<{@link Resource}<{@link WFRPCareerEntity}>>
     */
    @RequestMapping(path = "title_female/{titleFemale}",
            method = RequestMethod.GET)
    ...
    public List<Resource<WFRPCareerEntity>> save(
            @RequestBody
            final List<WFRPCareerEntity> entities) {
        List<Resource<WFRPCareerEntity>> resources =
                new ArrayList<Resource<WFRPCareerEntity>>();
    ...
    public List<Resource<WFRPCareerEntity>> save(
        ...
        if (entity.getAllowedGender() != null
            ...
            if (allowedGender == null) {
                allowedGender =
                        (WFRPGenderEntity) ((Resource) WFRPGenderController
                                .getInstance().save(
                                        entity.getAllowedGender())
                                .get(0)).getContent();
            }
        ...
        if (entity.getCareerEntries() != null
            ...
            for (int i = entity.getCareerEntries().size() - 1; i >= 0; i--) {
                ...
                if (careerEntries == null) {
                    careerEntries =
                            (WFRPCareerEntity) ((Resource) WFRPCareerController
                                    .getInstance()
                                    .save(entity.getCareerEntries().get(i))
                                    .get(0))
                                            .getContent();
                }
            ...
            for (int i = entity.getCareerExits().size() - 1; i >= 0; i--) {
                ...
                if (careerExits == null) {
                    careerExits =
                            (WFRPCareerEntity) ((Resource) WFRPCareerController
                                    .getInstance()
                                    .save(entity.getCareerExits().get(i))
                                    .get(0))
                                            .getContent();
                }
        ...
        if (entity.getDisallowedRaces() != null
            ...
            for (int i = entity.getDisallowedRaces().size() - 1; i >= 0; i--) {
                ...
                if (disallowedRaces == null) {
                    disallowedRaces =
                            (WFRPRaceEntity) ((Resource) WFRPRaceController
                                    .getInstance()
                                    .save(entity.getDisallowedRaces().get(i))
                                    .get(0))
                                            .getContent();
                }
                    ...
                    if (list == null) {
                        ...
                        if (method != null
                            ...
                            if (field.get(
                                ...
                                list = (List<
                                        Resource<WFRPEquipmentEntity>>) method
                                                .invoke(
                                                        WFRPEquipmentController
                                                                .getInstance(),
                                                        (String) field
