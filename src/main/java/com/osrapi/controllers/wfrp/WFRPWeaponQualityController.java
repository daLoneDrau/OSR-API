...
public class WFRPWeaponQualityController {
    ...
    public List<Resource<WFRPWeaponQualityEntity>> getAll() {
        Iterator<WFRPWeaponQualityEntity> iter = repository.findAll()
                .iterator();
        List<Resource<WFRPWeaponQualityEntity>> resources =
                new ArrayList<Resource<WFRPWeaponQualityEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<WFRPWeaponQualityEntity> getWeaponQualityResource(
        ...
        Resource<WFRPWeaponQualityEntity> resource =
                new Resource<WFRPWeaponQualityEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<WFRPWeaponQualityEntity>> save(
            @RequestBody
            final List<WFRPWeaponQualityEntity> entities) {
        List<Resource<WFRPWeaponQualityEntity>> resources =
                new ArrayList<Resource<WFRPWeaponQualityEntity>>();
