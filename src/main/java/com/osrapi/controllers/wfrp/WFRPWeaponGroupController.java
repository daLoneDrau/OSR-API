...
public class WFRPWeaponGroupController {
	...
	public List<Resource<WFRPWeaponGroupEntity>> getAll() {
		Iterator<WFRPWeaponGroupEntity> iter = repository.findAll()
				.iterator();
		List<Resource<WFRPWeaponGroupEntity>> resources = new ArrayList<Resource<WFRPWeaponGroupEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<WFRPWeaponGroupEntity> getWeaponGroupResource(
		...
		Resource<WFRPWeaponGroupEntity> resource = new Resource<WFRPWeaponGroupEntity>(
				entity);
		// link to entity
	...
	public List<Resource<WFRPWeaponGroupEntity>> save(
			@RequestBody final List<WFRPWeaponGroupEntity> entities) {
		List<Resource<WFRPWeaponGroupEntity>> resources = new ArrayList<Resource<WFRPWeaponGroupEntity>>();
	...
	public List<Resource<WFRPWeaponGroupEntity>> save(
			@RequestBody final WFRPWeaponGroupEntity entity) {
