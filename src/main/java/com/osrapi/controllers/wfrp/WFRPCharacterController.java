...
public class WFRPCharacterController {
	...
	public List<Resource<WFRPCharacterEntity>> getAll() {
		Iterator<WFRPCharacterEntity> iter = repository.findAll()
				.iterator();
		List<Resource<WFRPCharacterEntity>> resources = new ArrayList<Resource<WFRPCharacterEntity>>();
		while (iter.hasNext()) {
	...
	public List<Resource<WFRPCharacterEntity>> getByAgility(
			@PathVariable final Long agility) {
	...
	public List<Resource<WFRPCharacterEntity>> getByAttacks(
			@PathVariable final Long attacks) {
	 ...
	 * @return {@link List}<{@link Resource}<{@link WFRPCharacterEntity}>>
	 */
	@RequestMapping(path = "ballistic_skill/{ballisticSkill}", method = RequestMethod.GET)
	public List<Resource<WFRPCharacterEntity>> getByBallisticSkill(
			@PathVariable final Long ballisticSkill) {
	 ...
	 * @return {@link List}<{@link Resource}<{@link WFRPCharacterEntity}>>
	 */
	@RequestMapping(path = "fate_points/{fatePoints}", method = RequestMethod.GET)
	public List<Resource<WFRPCharacterEntity>> getByFatePoints(
			@PathVariable final Long fatePoints) {
		Iterator<WFRPCharacterEntity> iter = repository
	 ...
	 * @return {@link List}<{@link Resource}<{@link WFRPCharacterEntity}>>
	 */
	@RequestMapping(path = "fellowship/{fellowship}", method = RequestMethod.GET)
	public List<Resource<WFRPCharacterEntity>> getByFellowship(
			@PathVariable final Long fellowship) {
		Iterator<WFRPCharacterEntity> iter = repository
	 ...
	 * @return {@link List}<{@link Resource}<{@link WFRPCharacterEntity}>>
	 */
	@RequestMapping(path = "insanity_points/{insanityPoints}", method = RequestMethod.GET)
	public List<Resource<WFRPCharacterEntity>> getByInsanityPoints(
			@PathVariable final Long insanityPoints) {
		Iterator<WFRPCharacterEntity> iter = repository
	 ...
	 * @return {@link List}<{@link Resource}<{@link WFRPCharacterEntity}>>
	 */
	@RequestMapping(path = "intelligence/{intelligence}", method = RequestMethod.GET)
	public List<Resource<WFRPCharacterEntity>> getByIntelligence(
			@PathVariable final Long intelligence) {
		Iterator<WFRPCharacterEntity> iter = repository
	...
	public List<Resource<WFRPCharacterEntity>> getByMovement(
			@PathVariable final Long movement) {
	...
	public List<Resource<WFRPCharacterEntity>> getByStrength(
			@PathVariable final Long strength) {
	 ...
	 * @return {@link List}<{@link Resource}<{@link WFRPCharacterEntity}>>
	 */
	@RequestMapping(path = "strength_bonus/{strengthBonus}", method = RequestMethod.GET)
	public List<Resource<WFRPCharacterEntity>> getByStrengthBonus(
			@PathVariable final Long strengthBonus) {
		Iterator<WFRPCharacterEntity> iter = repository
	...
	public List<Resource<WFRPCharacterEntity>> getByToughness(
			@PathVariable final Long toughness) {
		Iterator<WFRPCharacterEntity> iter = repository
	 ...
	 * @return {@link List}<{@link Resource}<{@link WFRPCharacterEntity}>>
	 */
	@RequestMapping(path = "toughness_bonus/{toughnessBonus}", method = RequestMethod.GET)
	public List<Resource<WFRPCharacterEntity>> getByToughnessBonus(
			@PathVariable final Long toughnessBonus) {
		Iterator<WFRPCharacterEntity> iter = repository
	 ...
	 * @return {@link List}<{@link Resource}<{@link WFRPCharacterEntity}>>
	 */
	@RequestMapping(path = "weapon_skill/{weaponSkill}", method = RequestMethod.GET)
	public List<Resource<WFRPCharacterEntity>> getByWeaponSkill(
			@PathVariable final Long weaponSkill) {
		Iterator<WFRPCharacterEntity> iter = repository
	...
	public List<Resource<WFRPCharacterEntity>> getByWillPower(
			@PathVariable final Long willPower) {
		Iterator<WFRPCharacterEntity> iter = repository
	...
	public List<Resource<WFRPCharacterEntity>> getByWounds(
			@PathVariable final Long wounds) {
	...
	private Resource<WFRPCharacterEntity> getCharacterResource(
		...
		Resource<WFRPCharacterEntity> resource = new Resource<WFRPCharacterEntity>(
				entity);
		// link to entity
	...
	public List<Resource<WFRPCharacterEntity>> save(
			@RequestBody final List<WFRPCharacterEntity> entities) {
		List<Resource<WFRPCharacterEntity>> resources = new ArrayList<Resource<WFRPCharacterEntity>>();
	...
	public List<Resource<WFRPCharacterEntity>> save(
			@RequestBody final WFRPCharacterEntity entity) {
