...
public class WFRPWeaponController {
    ...
    public List<Resource<WFRPWeaponEntity>> getAll() {
        Iterator<WFRPWeaponEntity> iter = repository.findAll()
                .iterator();
        List<Resource<WFRPWeaponEntity>> resources =
                new ArrayList<Resource<WFRPWeaponEntity>>();
        while (iter.hasNext()) {
    ...
    public List<Resource<WFRPWeaponEntity>> save(
            @RequestBody
            final List<WFRPWeaponEntity> entities) {
        List<Resource<WFRPWeaponEntity>> resources =
                new ArrayList<Resource<WFRPWeaponEntity>>();
    ...
    public List<Resource<WFRPWeaponEntity>> save(
        ...
        if (entity.getMeleeWeaponData() != null
            ...
            try {
                ...
                if (list == null) {
                    ...
                    if (method != null
                        ...
                        if (field.get(entity.getMeleeWeaponData()) != null) {
                            list = (List<
                                    Resource<WFRPMeleeWeaponEntity>>) method
                                            .invoke(
            ...
            if (meleeWeaponData == null) {
                meleeWeaponData =
                        (WFRPMeleeWeaponEntity) ((Resource) WFRPMeleeWeaponController
                                .getInstance()
                                .save(entity.getMeleeWeaponData()).get(0))
                                        .getContent();
            }
        ...
        if (entity.getMissileWeaponData() != null
            ...
            try {
                ...
                if (list == null) {
                    ...
                    if (method != null
                        ...
                        if (field.get(entity.getMissileWeaponData()) != null) {
                            list = (List<
                                    Resource<WFRPMissileWeaponEntity>>) method
                                            .invoke(
                                                    WFRPMissileWeaponController
                                                            .getInstance(),
                                                    (String) field.get(entity
            ...
            if (missileWeaponData == null) {
                missileWeaponData =
                        (WFRPMissileWeaponEntity) ((Resource) WFRPMissileWeaponController
                                .getInstance()
                    ...
                    if (list == null) {
                        ...
                        if (method != null
                            ...
                            if (field.get(
                                ...
                                list = (List<Resource<
                                        WFRPWeaponQualityEntity>>) method
                                                .invoke(
                                                        WFRPWeaponQualityController
                                                                .getInstance(),
                                                        (String) field
        ...
        if (entity.getWeaponGroup() != null
            ...
            try {
                ...
                if (list == null) {
                    ...
                    if (method != null
                        ...
                        if (field.get(entity.getWeaponGroup()) != null) {
                            list = (List<
                                    Resource<WFRPWeaponGroupEntity>>) method
                                            .invoke(
            ...
            if (weaponGroup == null) {
                weaponGroup =
                        (WFRPWeaponGroupEntity) ((Resource) WFRPWeaponGroupController
                                .getInstance()
                                .save(entity.getWeaponGroup()).get(0))
                                        .getContent();
            }
