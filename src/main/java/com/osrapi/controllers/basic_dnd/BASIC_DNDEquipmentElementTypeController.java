...
public class BASIC_DNDEquipmentElementTypeController {
     ...
     * {@link BASIC_DNDEquipmentElementTypeController}.
     */
    ...
    public List<Resource<BASIC_DNDEquipmentElementTypeEntity>> getAll() {
        Iterator<BASIC_DNDEquipmentElementTypeEntity> iter =
                repository.findAll()
                        .iterator();
    ...
    /**
     * Gets a list of {@link BASIC_DNDEquipmentElementTypeEntity}s that share a
     * code.
     ...
     */
    private Resource<BASIC_DNDEquipmentElementTypeEntity>
    ...
    public List<Resource<BASIC_DNDEquipmentElementTypeEntity>> save(
        ...
        BASIC_DNDEquipmentElementTypeEntity savedEntity =
     ...
     * @param entities the list of {@link BASIC_DNDEquipmentElementTypeEntity}
     *            instances
     * @return {@link List}<{@link Resource}<{@link BASIC_DNDEquipmentElementTypeEntity}>>
     */
    ...
    public List<Resource<BASIC_DNDEquipmentElementTypeEntity>> save(
            @RequestBody
            final List<BASIC_DNDEquipmentElementTypeEntity> entities) {
        List<Resource<BASIC_DNDEquipmentElementTypeEntity>> resources =
                new ArrayList<Resource<BASIC_DNDEquipmentElementTypeEntity>>();
        Iterator<BASIC_DNDEquipmentElementTypeEntity> iter =
                entities.iterator();
    ...
    private void setIdFromRepository(
        ...
        try {
            ...
            try {
                ...
                field = BASIC_DNDEquipmentElementTypeEntity.class
            ...
            if (method != null
                ...
                if (field.get(entity) != null) {
                    old = (List<BASIC_DNDEquipmentElementTypeEntity>) method
                            .invoke(
