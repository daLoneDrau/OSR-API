...
public class LABLORDDieRollController {
    ...
    public List<Resource<LABLORDDieRollEntity>> getAll() {
        Iterator<LABLORDDieRollEntity> iter = repository.findAll()
                .iterator();
        List<Resource<LABLORDDieRollEntity>> resources =
                new ArrayList<Resource<LABLORDDieRollEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<LABLORDDieRollEntity> getDieRollResource(
        ...
        Resource<LABLORDDieRollEntity> resource =
                new Resource<LABLORDDieRollEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<LABLORDDieRollEntity>> save(
            @RequestBody
            final List<LABLORDDieRollEntity> entities) {
        List<Resource<LABLORDDieRollEntity>> resources =
                new ArrayList<Resource<LABLORDDieRollEntity>>();
