...
public class LABLORDCharacterClassController {
    ...
    public List<Resource<LABLORDCharacterClassEntity>> getAll() {
        Iterator<LABLORDCharacterClassEntity> iter = repository.findAll()
                .iterator();
        List<Resource<LABLORDCharacterClassEntity>> resources =
                new ArrayList<Resource<LABLORDCharacterClassEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<LABLORDCharacterClassEntity> getCharacterClassResource(
        ...
        Resource<LABLORDCharacterClassEntity> resource =
                new Resource<LABLORDCharacterClassEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<LABLORDCharacterClassEntity>> save(
        ...
        if (entity.getAbilities() != null
            ...
            for (int i = entity.getAbilities().size() - 1; i >= 0; i--) {
                ...
                try {
                    ...
                    if (method != null
                        ...
                        if (field.get(entity.getAbilities().get(i)) != null) {
                            list = (List<
                                    Resource<LABLORDClassAbilityEntity>>) method
                                            .invoke(
                    ...
                    if (list == null) {
                        ...
                        if (method != null
                            ...
                            if (field.get(
                                ...
                                list = (List<Resource<
                                        LABLORDClassAbilityEntity>>) method
                                                .invoke(
                                                        LABLORDClassAbilityController
                                                                .getInstance(),
                                                        (String) field
                ...
                if (abilities == null) {
                    abilities =
                            (LABLORDClassAbilityEntity) ((Resource) LABLORDClassAbilityController
                                    .getInstance()
        ...
        if (entity.getLanguages() != null
            ...
            for (int i = entity.getLanguages().size() - 1; i >= 0; i--) {
                ...
                try {
                    ...
                    if (method != null
                        ...
                        if (field.get(entity.getLanguages().get(i)) != null) {
                            list = (List<
                                    Resource<LABLORDLanguageEntity>>) method
                                            .invoke(
                ...
                if (languages == null) {
                    languages =
                            (LABLORDLanguageEntity) ((Resource) LABLORDLanguageController
                                    .getInstance()
                    ...
                    if (list == null) {
                        ...
                        if (method != null
                            ...
                            if (field.get(entity.getPrimeRequisites()
                                    .get(i)) != null) {
                                list = (List<
                                        Resource<LABLORDAbilityEntity>>) method
                                                .invoke(
                                                        LABLORDAbilityController
                                                                .getInstance(),
                                                        (String) field
                ...
                if (primeRequisites == null) {
                    primeRequisites =
                            (LABLORDAbilityEntity) ((Resource) LABLORDAbilityController
                                    .getInstance()
                                    .save(entity.getPrimeRequisites().get(i))
                                    .get(0))
                                            .getContent();
                }
        ...
        if (entity.getRequirements() != null
            ...
            for (int i = entity.getRequirements().size() - 1; i >= 0; i--) {
                ...
                try {
                    ...
                    if (method != null
                        ...
                        if (field
                            ...
                            list = (List<Resource<
                                    LABLORDAbilityRequirementEntity>>) method
                                            .invoke(
                ...
                if (requirements == null) {
                    requirements =
                            (LABLORDAbilityRequirementEntity) ((Resource) LABLORDAbilityRequirementController
                                    .getInstance()
                                    .save(entity.getRequirements().get(i))
                                    .get(0))
                                            .getContent();
                }
    ...
    public List<Resource<LABLORDCharacterClassEntity>> save(
            @RequestBody
            final List<LABLORDCharacterClassEntity> entities) {
        List<Resource<LABLORDCharacterClassEntity>> resources =
                new ArrayList<Resource<LABLORDCharacterClassEntity>>();
    ...
    private void setHitDiceIdFromRepository(
        ...
        if (memberEntity == null) {
            memberEntity =
                    (LABLORDDieRollEntity) ((Resource) LABLORDDieRollController
                            .getInstance().save(
                                    entity.getHitDice())
                            .get(0)).getContent();
        }
