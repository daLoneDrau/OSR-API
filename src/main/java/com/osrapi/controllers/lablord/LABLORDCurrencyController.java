...
public class LABLORDCurrencyController {
    ...
    public List<Resource<LABLORDCurrencyEntity>> getAll() {
        Iterator<LABLORDCurrencyEntity> iter = repository.findAll()
                .iterator();
        List<Resource<LABLORDCurrencyEntity>> resources =
                new ArrayList<Resource<LABLORDCurrencyEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<LABLORDCurrencyEntity> getCurrencyResource(
        ...
        Resource<LABLORDCurrencyEntity> resource =
                new Resource<LABLORDCurrencyEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<LABLORDCurrencyEntity>> save(
            @RequestBody
            final List<LABLORDCurrencyEntity> entities) {
        List<Resource<LABLORDCurrencyEntity>> resources =
                new ArrayList<Resource<LABLORDCurrencyEntity>>();
