...
public class LABLORDAbilityController {
	...
	private Resource<LABLORDAbilityEntity> getAbilityResource(
		...
		Resource<LABLORDAbilityEntity> resource = new Resource<LABLORDAbilityEntity>(
				entity);
		// link to entity
	...
	public List<Resource<LABLORDAbilityEntity>> getAll() {
		Iterator<LABLORDAbilityEntity> iter = repository.findAll()
				.iterator();
		List<Resource<LABLORDAbilityEntity>> resources = new ArrayList<Resource<LABLORDAbilityEntity>>();
		while (iter.hasNext()) {
	...
	public List<Resource<LABLORDAbilityEntity>> save(
			@RequestBody final LABLORDAbilityEntity entity) {
	...
	public List<Resource<LABLORDAbilityEntity>> save(
			@RequestBody final List<LABLORDAbilityEntity> entities) {
		List<Resource<LABLORDAbilityEntity>> resources = new ArrayList<Resource<LABLORDAbilityEntity>>();
