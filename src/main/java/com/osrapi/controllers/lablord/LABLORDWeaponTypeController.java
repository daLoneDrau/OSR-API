...
public class LABLORDWeaponTypeController {
	...
	public List<Resource<LABLORDWeaponTypeEntity>> getAll() {
		Iterator<LABLORDWeaponTypeEntity> iter = repository.findAll()
				.iterator();
		List<Resource<LABLORDWeaponTypeEntity>> resources = new ArrayList<Resource<LABLORDWeaponTypeEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<LABLORDWeaponTypeEntity> getWeaponTypeResource(
		...
		Resource<LABLORDWeaponTypeEntity> resource = new Resource<LABLORDWeaponTypeEntity>(
				entity);
		// link to entity
	...
	public List<Resource<LABLORDWeaponTypeEntity>> save(
			@RequestBody final LABLORDWeaponTypeEntity entity) {
	...
	public List<Resource<LABLORDWeaponTypeEntity>> save(
			@RequestBody final List<LABLORDWeaponTypeEntity> entities) {
		List<Resource<LABLORDWeaponTypeEntity>> resources = new ArrayList<Resource<LABLORDWeaponTypeEntity>>();
