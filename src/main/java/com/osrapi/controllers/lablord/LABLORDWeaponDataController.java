...
public class LABLORDWeaponDataController {
	...
	public List<Resource<LABLORDWeaponDataEntity>> getAll() {
		Iterator<LABLORDWeaponDataEntity> iter = repository.findAll()
				.iterator();
		List<Resource<LABLORDWeaponDataEntity>> resources = new ArrayList<Resource<LABLORDWeaponDataEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<LABLORDWeaponDataEntity> getWeaponDataResource(
		...
		Resource<LABLORDWeaponDataEntity> resource = new Resource<LABLORDWeaponDataEntity>(
				entity);
		// link to entity
	...
	public List<Resource<LABLORDWeaponDataEntity>> save(
			@RequestBody final LABLORDWeaponDataEntity entity) {
	...
	public List<Resource<LABLORDWeaponDataEntity>> save(
			@RequestBody final List<LABLORDWeaponDataEntity> entities) {
		List<Resource<LABLORDWeaponDataEntity>> resources = new ArrayList<Resource<LABLORDWeaponDataEntity>>();
