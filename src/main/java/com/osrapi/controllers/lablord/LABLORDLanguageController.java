...
public class LABLORDLanguageController {
    ...
    public List<Resource<LABLORDLanguageEntity>> getAll() {
        Iterator<LABLORDLanguageEntity> iter = repository.findAll()
                .iterator();
        List<Resource<LABLORDLanguageEntity>> resources =
                new ArrayList<Resource<LABLORDLanguageEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<LABLORDLanguageEntity> getLanguageResource(
        ...
        Resource<LABLORDLanguageEntity> resource =
                new Resource<LABLORDLanguageEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<LABLORDLanguageEntity>> save(
            @RequestBody
            final List<LABLORDLanguageEntity> entities) {
        List<Resource<LABLORDLanguageEntity>> resources =
                new ArrayList<Resource<LABLORDLanguageEntity>>();
