...
public class LABLORDClassAbilityController {
    ...
    public List<Resource<LABLORDClassAbilityEntity>> getAll() {
        Iterator<LABLORDClassAbilityEntity> iter = repository.findAll()
                .iterator();
        List<Resource<LABLORDClassAbilityEntity>> resources =
                new ArrayList<Resource<LABLORDClassAbilityEntity>>();
        while (iter.hasNext()) {
    ...
    private Resource<LABLORDClassAbilityEntity> getClassAbilityResource(
        ...
        Resource<LABLORDClassAbilityEntity> resource =
                new Resource<LABLORDClassAbilityEntity>(
                        entity);
        // link to entity
    ...
    public List<Resource<LABLORDClassAbilityEntity>> save(
            @RequestBody
            final List<LABLORDClassAbilityEntity> entities) {
        List<Resource<LABLORDClassAbilityEntity>> resources =
                new ArrayList<Resource<LABLORDClassAbilityEntity>>();
