...
public class LABLORDArmorController {
	...
	public List<Resource<LABLORDArmorEntity>> getAll() {
		Iterator<LABLORDArmorEntity> iter = repository.findAll()
				.iterator();
		List<Resource<LABLORDArmorEntity>> resources = new ArrayList<Resource<LABLORDArmorEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<LABLORDArmorEntity> getArmorResource(
		...
		Resource<LABLORDArmorEntity> resource = new Resource<LABLORDArmorEntity>(
				entity);
		// link to entity
	...
	public List<Resource<LABLORDArmorEntity>> save(
			@RequestBody final LABLORDArmorEntity entity) {
	...
	public List<Resource<LABLORDArmorEntity>> save(
			@RequestBody final List<LABLORDArmorEntity> entities) {
		List<Resource<LABLORDArmorEntity>> resources = new ArrayList<Resource<LABLORDArmorEntity>>();
	...
	private void setTypeIdFromRepository(
		...
		if (memberEntity == null) {
			memberEntity = (LABLORDArmorTypeEntity) ((Resource) LABLORDArmorTypeController
					.getInstance().save(
							entity.getType())
					.get(0)).getContent();
		}
