...
public class LABLORDEquipmentTypeController {
	...
	public List<Resource<LABLORDEquipmentTypeEntity>> getAll() {
		Iterator<LABLORDEquipmentTypeEntity> iter = repository.findAll()
				.iterator();
		List<Resource<LABLORDEquipmentTypeEntity>> resources = new ArrayList<Resource<LABLORDEquipmentTypeEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<LABLORDEquipmentTypeEntity> getEquipmentTypeResource(
		...
		Resource<LABLORDEquipmentTypeEntity> resource = new Resource<LABLORDEquipmentTypeEntity>(
				entity);
		// link to entity
	...
	public List<Resource<LABLORDEquipmentTypeEntity>> save(
			@RequestBody final LABLORDEquipmentTypeEntity entity) {
	...
	public List<Resource<LABLORDEquipmentTypeEntity>> save(
			@RequestBody final List<LABLORDEquipmentTypeEntity> entities) {
		List<Resource<LABLORDEquipmentTypeEntity>> resources = new ArrayList<Resource<LABLORDEquipmentTypeEntity>>();
