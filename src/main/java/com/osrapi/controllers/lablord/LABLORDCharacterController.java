...
public class LABLORDCharacterController {
	...
	public List<Resource<LABLORDCharacterEntity>> getAll() {
		Iterator<LABLORDCharacterEntity> iter = repository.findAll()
				.iterator();
		List<Resource<LABLORDCharacterEntity>> resources = new ArrayList<Resource<LABLORDCharacterEntity>>();
		while (iter.hasNext()) {
	 ...
	 * @return {@link List}<{@link Resource}<{@link LABLORDCharacterEntity}>>
	 */
	@RequestMapping(path = "armor_class/{armorClass}", method = RequestMethod.GET)
	public List<Resource<LABLORDCharacterEntity>> getByArmorClass(
			@PathVariable final Long armorClass) {
	...
	public List<Resource<LABLORDCharacterEntity>> getByCharisma(
			@PathVariable final Long charisma) {
		Iterator<LABLORDCharacterEntity> iter = repository
	 ...
	 * @return {@link List}<{@link Resource}<{@link LABLORDCharacterEntity}>>
	 */
	@RequestMapping(path = "constitution/{constitution}", method = RequestMethod.GET)
	public List<Resource<LABLORDCharacterEntity>> getByConstitution(
			@PathVariable final Long constitution) {
		Iterator<LABLORDCharacterEntity> iter = repository
	...
	public List<Resource<LABLORDCharacterEntity>> getByDexterity(
			@PathVariable final Long dexterity) {
		Iterator<LABLORDCharacterEntity> iter = repository
	 ...
	 * @return {@link List}<{@link Resource}<{@link LABLORDCharacterEntity}>>
	 */
	@RequestMapping(path = "experience/{experience}", method = RequestMethod.GET)
	public List<Resource<LABLORDCharacterEntity>> getByExperience(
			@PathVariable final Long experience) {
		Iterator<LABLORDCharacterEntity> iter = repository
	...
	public List<Resource<LABLORDCharacterEntity>> getByHitPoints(
			@PathVariable final Long hitPoints) {
		Iterator<LABLORDCharacterEntity> iter = repository
	 ...
	 * @return {@link List}<{@link Resource}<{@link LABLORDCharacterEntity}>>
	 */
	@RequestMapping(path = "max_hit_points/{maxHitPoints}", method = RequestMethod.GET)
	public List<Resource<LABLORDCharacterEntity>> getByMaxHitPoints(
			@PathVariable final Long maxHitPoints) {
		Iterator<LABLORDCharacterEntity> iter = repository
	...
	public List<Resource<LABLORDCharacterEntity>> getByWisdom(
			@PathVariable final Long wisdom) {
	...
	private Resource<LABLORDCharacterEntity> getCharacterResource(
		...
		Resource<LABLORDCharacterEntity> resource = new Resource<LABLORDCharacterEntity>(
				entity);
		// link to entity
	...
	public List<Resource<LABLORDCharacterEntity>> save(
			@RequestBody final LABLORDCharacterEntity entity) {
	...
	public List<Resource<LABLORDCharacterEntity>> save(
			@RequestBody final List<LABLORDCharacterEntity> entities) {
		List<Resource<LABLORDCharacterEntity>> resources = new ArrayList<Resource<LABLORDCharacterEntity>>();
