...
public class LABLORDDamageController {
	...
	public List<Resource<LABLORDDamageEntity>> getAll() {
		Iterator<LABLORDDamageEntity> iter = repository.findAll()
				.iterator();
		List<Resource<LABLORDDamageEntity>> resources = new ArrayList<Resource<LABLORDDamageEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<LABLORDDamageEntity> getDamageResource(
		...
		Resource<LABLORDDamageEntity> resource = new Resource<LABLORDDamageEntity>(
				entity);
		// link to entity
	...
	public List<Resource<LABLORDDamageEntity>> save(
			@RequestBody final LABLORDDamageEntity entity) {
	...
	public List<Resource<LABLORDDamageEntity>> save(
			@RequestBody final List<LABLORDDamageEntity> entities) {
		List<Resource<LABLORDDamageEntity>> resources = new ArrayList<Resource<LABLORDDamageEntity>>();
