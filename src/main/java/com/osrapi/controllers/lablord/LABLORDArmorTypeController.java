...
public class LABLORDArmorTypeController {
	...
	public List<Resource<LABLORDArmorTypeEntity>> getAll() {
		Iterator<LABLORDArmorTypeEntity> iter = repository.findAll()
				.iterator();
		List<Resource<LABLORDArmorTypeEntity>> resources = new ArrayList<Resource<LABLORDArmorTypeEntity>>();
		while (iter.hasNext()) {
	...
	private Resource<LABLORDArmorTypeEntity> getArmorTypeResource(
		...
		Resource<LABLORDArmorTypeEntity> resource = new Resource<LABLORDArmorTypeEntity>(
				entity);
		// link to entity
	...
	public List<Resource<LABLORDArmorTypeEntity>> save(
			@RequestBody final LABLORDArmorTypeEntity entity) {
	...
	public List<Resource<LABLORDArmorTypeEntity>> save(
			@RequestBody final List<LABLORDArmorTypeEntity> entities) {
		List<Resource<LABLORDArmorTypeEntity>> resources = new ArrayList<Resource<LABLORDArmorTypeEntity>>();
